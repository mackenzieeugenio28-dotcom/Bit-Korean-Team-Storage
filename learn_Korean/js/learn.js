...
function finishQuiz() {
  ...
  document.getElementById('quizResultTitle').textContent = Lang.t(Learn.quiz.passed ? 'learn.result.title.pass' : 'learn.result.title.fail');
  ...
  if (Learn.quiz.passed) {
    ...
    xpEl.textContent = Lang.t('learn.result.xp');
